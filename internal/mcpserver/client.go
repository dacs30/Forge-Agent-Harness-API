...
func (c *haasClient) listEnvironments(ctx context.Context) ([]*apitypes.Environment, error) {
...
func (c *haasClient) getEnvironment(ctx context.Context, id string) (*apitypes.Environment, error) {
